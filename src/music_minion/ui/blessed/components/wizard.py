...
def render_smart_playlist_wizard(term: Terminal, state: UIState, y: int, height: int) -> None:
    """
    ...
    if current_step == 'field':
        lines_rendered = _render_field_step(term, state, y + line_num, height - line_num)
        line_num += lines_rendered
    elif current_step == 'operator':
        lines_rendered = _render_operator_step(term, state, y + line_num, height - line_num)
        line_num += lines_rendered
    elif current_step == 'value':
        lines_rendered = _render_value_step(term, state, y + line_num, height - line_num)
        line_num += lines_rendered
    elif current_step == 'conjunction':
        lines_rendered = _render_conjunction_step(term, state, y + line_num, height - line_num)
        line_num += lines_rendered
    elif current_step == 'preview':
        lines_rendered = _render_preview_step(term, state, y + line_num, height - line_num)
        line_num += lines_rendered
...
def _render_conjunction_step(term: Terminal, state: UIState, y: int, height: int) -> int:
    """
